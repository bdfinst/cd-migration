...
**[Work in progress]({{< relref "/docs/reference/glossary#wip-work-in-progress" >}}):**
...
|----------|---------------------|
| [Trunk-based development]({{< relref "/docs/migrate-to-cd/foundations/trunk-based-development" >}}) | CI agreement: daily integration, branch age < 24h |
| [Testing fundamentals]({{< relref "/docs/migrate-to-cd/foundations/testing-fundamentals" >}}) | DoD: all tests pass. CI: tests pass before merge |
| [Build automation]({{< relref "/docs/migrate-to-cd/foundations/build-automation" >}}) | CI: build runs on every commit. Broken build = top priority |
