...
3. Decouple service deployments using backward-compatible changes and [feature flags]({{< relref "/docs/reference/glossary#feature-flag" >}})
...
Pipeline improvement follows the Theory of [Constraints]({{< relref "/docs/reference/glossary#constraint" >}}): identify the single biggest
...
- **Flaky failures and re-runs** - time lost to investigating and re-running non-deterministic
  failures
- **Large [batch sizes]({{< relref "/docs/reference/glossary#batch-size" >}})** - pipelines triggered by large, infrequent commits that take
...
- **[Lead time]({{< relref "/docs/reference/glossary#lead-time-for-changes" >}})** - time from commit to production deployment
...
[single path to production]({{< relref "/docs/migrate-to-cd/pipeline/single-path-to-production" >}}) defines the route. The
[deterministic pipeline]({{< relref "/docs/migrate-to-cd/pipeline/deterministic-pipeline" >}}) ensures reliability. The
[deployable definition]({{< relref "/docs/migrate-to-cd/pipeline/deployable-definition" >}}) defines the quality gates. The
...
- [No Fast Feedback]({{< relref "/docs/symptoms/flow/integration/no-fast-feedback" >}}) - a symptom that pipeline architecture improvements resolve through stage ordering and parallelization
- [Missing Deployment Pipeline]({{< relref "/docs/anti-patterns/pipeline/missing-deployment-pipeline" >}}) - the anti-pattern that pipeline architecture replaces
- [Release Frequency]({{< relref "/docs/reference/metrics/release-frequency" >}}) - a key metric that improves as pipeline architecture matures toward loose coupling
- [Phase 3: Optimize]({{< relref "/docs/migrate-to-cd/optimize" >}}) - the next phase, which builds on mature pipeline architecture
