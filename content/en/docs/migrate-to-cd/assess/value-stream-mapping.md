...
In the context of a [CD]({{< relref "/docs/reference/glossary#cd-continuous-delivery" >}}) migration, a [value stream map]({{< relref "/docs/reference/glossary#value-stream-map" >}}) is not an academic exercise. It is the
...
in [Document Your Current Process]({{< relref "/docs/migrate-to-cd/brownfield/document-current-process" >}}), elevated to a
...
1. **Start bottom-up.** Have each team [document its current process]({{< relref "/docs/migrate-to-cd/brownfield/document-current-process" >}})
...
|------------|---------------|---------------------------|
| Long-lived feature branches | Days of integration delay, merge conflicts | Phase 1 ([Trunk-Based Development]({{< relref "/docs/reference/glossary#tbd-trunk-based-development" >}})) |
| Manual regression testing | Days to weeks of wait time | Phase 1 (Testing Fundamentals) |
| Environment provisioning | Hours to days of wait time | Phase 2 ([Production-Like Environments]({{< relref "/docs/reference/glossary#production-like-environment" >}})) |
...
These numbers become part of your [baseline metrics]({{< relref "/docs/migrate-to-cd/assess/baseline-metrics" >}}) and feed directly into
your work to [identify constraints]({{< relref "/docs/migrate-to-cd/assess/identify-constraints" >}}).
...
With your value stream map in hand, proceed to [Baseline Metrics]({{< relref "/docs/migrate-to-cd/assess/baseline-metrics" >}}) to
...
- [Coordinated Deployments]({{< relref "/docs/symptoms/deployment/coordinated-deployments" >}}) - a deployment symptom visible as cross-team handoffs in the value stream
- [Hardening Sprints]({{< relref "/docs/symptoms/deployment/hardening-sprints" >}}) - a symptom that appears as a large testing phase on the map
- [Development Cycle Time]({{< relref "/docs/reference/metrics/development-cycle-time" >}}) - a metric that value stream mapping helps you measure
- [Identify Constraints]({{< relref "/docs/migrate-to-cd/assess/identify-constraints" >}}) - the next step that uses your value stream map to find the biggest bottleneck
