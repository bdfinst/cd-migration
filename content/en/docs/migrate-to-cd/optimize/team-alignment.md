...
4. **Contract tests.** Write tests that verify the producer honors the contract. Write tests that
   verify the consumer handles the contract correctly. See [Contract Testing]({{< relref "/docs/testing/test-types/contract" >}})
...
- [Contract Testing]({{< relref "/docs/testing/test-types/contract" >}}) - how to define and enforce the contracts between domain teams
