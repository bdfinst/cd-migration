...
|--------|-----------------|
| [Release frequency]({{< relref "/docs/reference/metrics/release-frequency" >}}) | Should increase from weekly or bi-weekly toward multiple times per week |
| Changes per release | Should decrease as release frequency increases |
| [Change fail rate]({{< relref "/docs/reference/metrics/change-fail-rate" >}}) | Should decrease as smaller, more frequent releases carry less risk |
| [Lead time]({{< relref "/docs/reference/metrics/lead-time" >}}) | Should decrease as artificial scheduling delay is removed |
