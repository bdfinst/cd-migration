...
Half the team uses feature branches; half commit directly to main. Some developers expect code reviews to happen within a few hours; others consider three days fast. Some engineers put every change through a full review; others self-merge small fixes. The [WIP]({{< relref "/docs/reference/glossary#wip-work-in-progress" >}}) limit is nominally three items per person but nobody enforces it and most people carry five or six.
...
WIP limits create the conditions where norms matter. When the team is committed to a WIP limit, review turnaround, merge cadence, and [integration frequency]({{< relref "/docs/reference/glossary#integration-frequency" >}}) become practical necessities rather than theoretical preferences.
...
1. **Does the team have written [working agreements]({{< relref "/docs/reference/glossary#working-agreement" >}}) that everyone follows?** If agreements are verbal or assumed, they will diverge under pressure. The absence of written agreements is the starting point.
2. **Do team members pull from a shared queue or receive individual assignments?** Individual assignment reduces team-level flow ownership. Start with [Push-based work assignment]({{< relref "/docs/anti-patterns/team-workflow/push-based-work-assignment" >}}).
3. **Does the team enforce WIP limits?** Without enforced limits, work accumulates until norms break down. Start with [Unbounded WIP]({{< relref "/docs/anti-patterns/team-workflow/unbounded-wip" >}}).
