...
| [Lead time](../../../metrics/lead-time/) | Should decrease as features are decomposed and shipped incrementally rather than held for a committed date |
...
| [Change fail rate](../../../metrics/change-fail-rate/) | Should decrease as the pressure to rush incomplete work to a committed date is reduced |
...
- [Deadline-Driven Development](../deadline-driven-development/) - The sprint-level version of the same pressure
- [Missing Product Ownership](../missing-product-ownership/) - Without a product owner, there is nobody to renegotiate scope as understanding develops
- [Work Decomposition](../../../migrate-to-cd/migration-path/foundations/work-decomposition/) - Breaking features into pieces that can ship independently
- [Small Batches](../../../migrate-to-cd/migration-path/optimize/small-batches/) - The delivery practice that makes distant date commitments unnecessary
- [Metrics-Driven Improvement](../../../migrate-to-cd/migration-path/optimize/metrics-driven-improvement/) - Using historical delivery data to make more accurate forecasts
