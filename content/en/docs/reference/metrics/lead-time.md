...
commit to production, which the *Accelerate* research calls "[lead time for changes]({{< relref "/docs/reference/glossary#lead-time-for-changes" >}})."
...
For teams practicing [continuous deployment]({{< relref "/docs/reference/glossary#continuous-deployment" >}}), lead time may be nearly identical to
