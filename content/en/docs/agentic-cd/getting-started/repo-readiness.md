...
- Remove external service dependencies from unit tests. Use [test doubles]({{< relref "/docs/reference/testing/test-doubles" >}}) for anything outside the process boundary.
