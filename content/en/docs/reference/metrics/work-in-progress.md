...
{{< card code=true header="**Work in Progress formula**" lang="text" >}}
...
[Development Cycle Time]({{< relref "/docs/reference/metrics/development-cycle-time" >}}) or
[Lead Time]({{< relref "/docs/reference/metrics/lead-time" >}}), WIP tells you about problems that are happening right
...
{{< card code=true header="**Little's Law: cycle time as a function of WIP**" lang="text" >}}
...
- **Predicts cycle time.** Per Little's Law, WIP and cycle time are directly
  ...
  [Development Cycle Time]({{< relref "/docs/reference/metrics/development-cycle-time" >}}) without changing anything
...
- **Supports [trunk-based development]({{< relref "/docs/reference/glossary#tbd-trunk-based-development" >}}).** High WIP often correlates with many
  ...
  [Integration Frequency]({{< relref "/docs/reference/metrics/integration-frequency" >}}) goals.
