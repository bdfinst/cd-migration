...
UI" are each multi-day items. Nothing is [deployable]({{< relref "/docs/reference/glossary#deployable" >}}) until all layers are done. Vertical slicing
...
to finish quickly. [Trunk-based development]({{< relref "/docs/reference/glossary#tbd-trunk-based-development" >}}) creates natural pressure to keep items small enough to
integrate daily.
...
**Ready to fix this?** The most common cause is [Monolithic Work Items]({{< relref "/docs/anti-patterns/team-workflow/monolithic-work-items" >}}). Start with its [How to Fix It]({{< relref "/docs/anti-patterns/team-workflow/monolithic-work-items#how-to-fix-it" >}}) section for week-by-week steps.
