...
: *Most relevant to: [Phase 2: Pipeline]({{< relref "/docs/migrate-to-cd/pipeline" >}})*
...
: *Most relevant to: [Phase 0: Assess]({{< relref "/docs/migrate-to-cd/assess" >}}) and [Phase 3: Metrics-Driven Improvement]({{< relref "/docs/migrate-to-cd/optimize/metrics-driven-improvement" >}})*
...
: *Most relevant to: [Phase 4: Deliver on Demand]({{< relref "/docs/migrate-to-cd/continuous-deployment" >}}) and [Phase 2: Rollback]({{< relref "/docs/migrate-to-cd/pipeline/rollback" >}})*
...
: *Most relevant to: Building organizational buy-in during [Phase 0]({{< relref "/docs/migrate-to-cd/assess" >}})*
...
: *Most relevant to: [Phase 1: Testing Fundamentals]({{< relref "/docs/migrate-to-cd/foundations/testing-fundamentals" >}})*
...
: *Most relevant to: [Phase 1: Work Decomposition]({{< relref "/docs/migrate-to-cd/foundations/work-decomposition" >}})*
...
: *Most relevant to: [Phase 3: Optimize]({{< relref "/docs/migrate-to-cd/optimize" >}})*
...
: *Most relevant to: [Phase 3: Limiting WIP]({{< relref "/docs/migrate-to-cd/optimize/limiting-wip" >}})*
...
: *Most relevant to: [Phase 2: Pipeline]({{< relref "/docs/migrate-to-cd/pipeline" >}}) and [Phase 3: Small Batches]({{< relref "/docs/migrate-to-cd/optimize/small-batches" >}})*
...
: *Most relevant to: [Phase 3: Architecture Decoupling]({{< relref "/docs/migrate-to-cd/optimize/architecture-decoupling" >}})*
...
: Jez Humble's conference presentations cover the principles and research behind CD. His talk
  ...
  new to the concept.
: *Most relevant to: Building understanding during [Phase 0]({{< relref "/docs/migrate-to-cd/assess" >}})*
...
: *Most relevant to: [Phase 1: Foundations]({{< relref "/docs/migrate-to-cd/foundations" >}})*
...
: *Most relevant to: [Phase 1: Work Decomposition]({{< relref "/docs/migrate-to-cd/foundations/work-decomposition" >}}) and [Phase 3: Small Batches]({{< relref "/docs/migrate-to-cd/optimize/small-batches" >}})*
