...
**Read more:** [No On-Call or Operational Ownership]({{< relref "/docs/anti-patterns/organizational-cultural/team-dynamics/no-operational-ownership" >}})
...
1. **Does the team file tickets for infrastructure changes that should take minutes?** If
   ...
   [Separate Ops/Release Team]({{< relref "/docs/anti-patterns/organizational-cultural/governance-process/separate-ops-team" >}}).
2. **Does the team own the operational concerns of what they build?** If another team manages
   ...
   [No On-Call or Operational Ownership]({{< relref "/docs/anti-patterns/organizational-cultural/team-dynamics/no-operational-ownership" >}}).
...
- [Sprint Planning Is Dominated by Dependency Negotiation]({{< relref "/docs/symptoms/flow/work-management/dependency-heavy-planning" >}}) - Cross-team waits that dominate planning
- [Separate Ops/Release Team]({{< relref "/docs/anti-patterns/organizational-cultural/governance-process/separate-ops-team" >}}) - Structural separation that prevents self-service
- [No On-Call or Operational Ownership]({{< relref "/docs/anti-patterns/organizational-cultural/team-dynamics/no-operational-ownership" >}}) - Delivery teams without operational responsibility
