...
- [Build Duration](../../metrics/build-duration/) - Measuring and improving CI pipeline speed
- [Integration Frequency](../../metrics/integration-frequency/) - How feedback speed affects integration cadence
- [Development Cycle Time](../../metrics/development-cycle-time/) - End-to-end flow from change to production
