...
- **[Leadership Sees CD as a Technical Nice-to-Have]({{< relref "/docs/symptoms/visibility/no-leadership-buy-in" >}})** - Without leadership buy-in, improvement efforts stall and funding is at risk.
- **[The Team Is Chasing DORA Benchmarks]({{< relref "/docs/symptoms/visibility/chasing-dora-benchmarks" >}})** - Metrics become targets, which distorts team behavior and undermines genuine improvement.
...
- **[AI-Generated Code Ships Without Developer Understanding]({{< relref "/docs/symptoms/testing/ai-code-without-understanding" >}})** - Code is merged without the team understanding what it does, creating hidden quality risk.
...
- **[Releases Depend on One Person]({{< relref "/docs/symptoms/deployment/release-manager-bottleneck" >}})** - A single release manager creates a bus-factor risk and a bottleneck on every deployment.
- **[Every Change Requires a Ticket and Approval Chain]({{< relref "/docs/symptoms/deployment/change-management-overhead" >}})** - Heavyweight change management slows delivery without proportionally reducing risk.
- **[No Evidence of What Was Deployed or When]({{< relref "/docs/symptoms/deployment/no-deployment-audit-trail" >}})** - There is no audit trail, making compliance and incident investigation harder.
