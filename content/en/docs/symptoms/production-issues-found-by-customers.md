...
**Read more:** [No Pipeline Exists](../anti-patterns/pipeline/no-pipeline-exists/)
...
2. **Is the deployment process automated with health checks?** If deployments are manual or
   ...
   [No Pipeline Exists](../anti-patterns/pipeline/no-pipeline-exists/).
3. **Does the team check a dashboard after every deployment?** If the answer is "sometimes" or
   ...
   [No Observability](../anti-patterns/monitoring-observability/no-observability/) to build
