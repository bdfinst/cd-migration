...
|-------|-------------------|-------------------|-------------------|-----|
| Schema migration and backward compatibility failures | [CI]({{< relref "/docs/reference/glossary#ci-continuous-integration" >}}) | Schema compatibility validators, migration dry-runs | Predict downstream impact by understanding consumer usage patterns | Expand-then-contract schema migrations; never breaking changes |
