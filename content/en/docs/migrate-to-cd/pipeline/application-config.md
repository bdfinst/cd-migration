...
environments from what does not, so that a single [immutable artifact]({{< relref "/docs/migrate-to-cd/pipeline/immutable-artifacts" >}})
...
- **Application config** - settings that define how the application behaves, are the same
  in every environment, and should be bundled with the [artifact]({{< relref "/docs/reference/glossary#artifact" >}}). Examples: routing rules,
  [feature flag]({{< relref "/docs/reference/glossary#feature-flag" >}}) defaults, serialization formats, timeout policies, retry strategies.
...
[pipeline]({{< relref "/docs/reference/glossary#pipeline" >}}). All configuration injection must be automated.
...
[immutable artifacts]({{< relref "/docs/migrate-to-cd/pipeline/immutable-artifacts" >}}) practical. An artifact can only be truly
...
[production-like environments]({{< relref "/docs/migrate-to-cd/pipeline/production-like-environments" >}}) - because the same
...
When configuration is externalized correctly, [rollback]({{< relref "/docs/migrate-to-cd/pipeline/rollback" >}}) becomes
...
- [Snowflake Environments]({{< relref "/docs/anti-patterns/pipeline/snowflake-environments" >}}) - an anti-pattern that proper configuration separation helps prevent
- [Everything as Code]({{< relref "/docs/migrate-to-cd/foundations/everything-as-code" >}}) - the Foundations practice that establishes version control for configuration
- [Immutable Artifacts]({{< relref "/docs/migrate-to-cd/pipeline/immutable-artifacts" >}}) - the Pipeline practice that depends on correct configuration separation
- [Production-Like Environments]({{< relref "/docs/migrate-to-cd/pipeline/production-like-environments" >}}) - environments where externalized configuration is injected at deployment time
