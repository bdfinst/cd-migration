...
|--------|-----------------|
| [Lead time]({{< relref "/docs/reference/metrics/lead-time" >}}) | Should decrease significantly as queue times between handoffs are reduced |
...
| [Mean time to repair]({{< relref "/docs/reference/metrics/mean-time-to-repair" >}}) | Should decrease as the team building the service also operates it |
