...
|-----------------|-----------------|----------------|
| Development practices (BDD, trunk-based development) | [Phase 1 - Foundations](../migrate-to-cd/migration-path/foundations/) | These are prerequisites for CI, which is a prerequisite for everything else |
