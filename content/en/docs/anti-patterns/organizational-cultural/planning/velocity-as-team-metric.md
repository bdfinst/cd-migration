...
Remove velocity from management dashboards and stakeholder reports. It is an internal planning tool, not an organizational KPI. If management needs visibility into delivery output, introduce [lead time]({{< relref "/docs/reference/metrics/lead-time" >}}) and [release frequency]({{< relref "/docs/reference/metrics/release-frequency" >}}) as replacements.
...
- [Lead time]({{< relref "/docs/reference/metrics/lead-time" >}}) - time from work starting to deployment
- [Release frequency]({{< relref "/docs/reference/metrics/release-frequency" >}}) - how often the team ships
- [Change fail rate]({{< relref "/docs/reference/metrics/change-fail-rate" >}}) - what percentage of changes cause problems
- [Development cycle time]({{< relref "/docs/reference/metrics/development-cycle-time" >}}) - time in development
...
|--------|-----------------|
| [Lead time]({{< relref "/docs/reference/metrics/lead-time" >}}) | Decreasing trend as the team focuses on finishing rather than accumulating points |
| [Release frequency]({{< relref "/docs/reference/metrics/release-frequency" >}}) | Increasing as the team ships smaller batches rather than large point-heavy sprints |
| [Change fail rate]({{< relref "/docs/reference/metrics/change-fail-rate" >}}) | Stable or decreasing as quality shortcuts decline |
