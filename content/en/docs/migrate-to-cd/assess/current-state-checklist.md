...
development]({{< relref "/docs/reference/glossary#tbd-trunk-based-development" >}}) eliminates integration as a separate, painful event and makes it a continuous,
trivial activity. Without this practice, [continuous integration]({{< relref "/docs/reference/glossary#ci-continuous-integration" >}}) is impossible, and without
continuous integration, [continuous delivery]({{< relref "/docs/reference/glossary#cd-continuous-delivery" >}}) is impossible.
...
- [ ] Build [artifacts]({{< relref "/docs/reference/glossary#artifact" >}}) are created once and promoted through environments (not rebuilt for each environment)
...
- [ ] The team can [roll back]({{< relref "/docs/reference/glossary#rollback" >}}) a production deployment within minutes, not hours
...
- [ ] A build that passes all automated checks is considered [deployable]({{< relref "/docs/reference/glossary#deployable" >}}) without additional manual verification
...
|-------|--------------------|--------------------|
| **0-5** | You are early in your journey. Most foundational practices are not yet in place. | Start at the beginning of **[Phase 1 - Foundations]({{< relref "/docs/migrate-to-cd/foundations" >}})**. Focus on trunk-based development and basic test automation first. |
| **6-12** | You have some practices in place but significant gaps remain. This is the most common starting point. | Start with **[Phase 1 - Foundations]({{< relref "/docs/migrate-to-cd/foundations" >}})** but focus on the categories where you had the fewest checks. Your [constraint analysis]({{< relref "/docs/migrate-to-cd/assess/identify-constraints" >}}) will tell you which gap to close first. |
| **13-18** | Your foundations are solid. The gaps are likely in pipeline automation and deployment practices. | You may be able to move quickly through Phase 1 and focus your effort on **[Phase 2 - Pipeline]({{< relref "/docs/anti-patterns/pipeline" >}})**. Validate with your value stream map that your remaining constraints match. |
| **19-22** | You are well-practiced in most areas. Your migration is about closing specific gaps and optimizing flow. | Review your unchecked items - they point to specific topics in **[Phase 3 - Optimize]({{< relref "/docs/migrate-to-cd/optimize" >}})** or **[Phase 4 - Deliver on Demand]({{< relref "/docs/migrate-to-cd/continuous-deployment" >}})**. |
| **23-25** | You are already practicing most of what MinimumCD defines. Your focus should be on consistency and delivering on demand. | Jump to **[Phase 4 - Deliver on Demand]({{< relref "/docs/migrate-to-cd/continuous-deployment" >}})** and focus on the capability to deploy any change when needed. |
...
1. **A [value stream map]({{< relref "/docs/reference/glossary#value-stream-map" >}})** showing your end-to-end delivery process with wait times and rework loops
2. **[Baseline metrics]({{< relref "/docs/reference/glossary#baseline-metrics" >}})** for [deployment frequency]({{< relref "/docs/reference/glossary#deployment-frequency" >}}), [lead time]({{< relref "/docs/reference/glossary#lead-time-for-changes" >}}), [change failure rate]({{< relref "/docs/reference/glossary#change-failure-rate-cfr" >}}), and [MTTR]({{< relref "/docs/reference/glossary#mean-time-to-restore-mttr" >}})
3. **An identified top [constraint]({{< relref "/docs/reference/glossary#constraint" >}})** telling you where to focus first
...
You are ready to begin [Phase 1 - Foundations]({{< relref "/docs/migrate-to-cd/foundations" >}}). Start with the practice area
...
- [Slow Test Suites]({{< relref "/docs/symptoms/testing/slow-test-suites" >}}) - a symptom that surfaces when automated testing practices are immature
- [Manual Regression Testing Gates]({{< relref "/docs/anti-patterns/testing/manual-regression-testing-gates" >}}) - an anti-pattern the Quality section of this checklist helps identify
- [Missing Deployment Pipeline]({{< relref "/docs/anti-patterns/pipeline/missing-deployment-pipeline" >}}) - an anti-pattern the Pipeline Practices section helps detect
- [Phase 1: Foundations]({{< relref "/docs/migrate-to-cd/foundations" >}}) - where to begin after completing your assessment
