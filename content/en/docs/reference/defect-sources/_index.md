...
|----------|---------------|
| [Product & Discovery]({{< relref "/docs/reference/defect-sources/product-and-discovery" >}}) | Wrong features, misaligned requirements, accessibility gaps - defects born before coding begins |
| [Integration & Boundaries]({{< relref "/docs/reference/defect-sources/integration-and-boundaries" >}}) | Interface mismatches, behavioral assumptions, race conditions at service boundaries |
| [Knowledge & Communication]({{< relref "/docs/reference/defect-sources/knowledge-and-communication" >}}) | Implicit domain knowledge, ambiguous requirements, tribal knowledge loss, divergent mental models |
| [Change & Complexity]({{< relref "/docs/reference/defect-sources/change-and-complexity" >}}) | Unintended side effects, technical debt, feature interactions, configuration drift |
| [Testing & Observability Gaps]({{< relref "/docs/reference/defect-sources/testing-and-observability-gaps" >}}) | Untested edge cases, missing contract tests, insufficient monitoring, environment parity |
| [Process & Deployment]({{< relref "/docs/reference/defect-sources/process-and-deployment" >}}) | Long-lived branches, manual steps, large batches, inadequate [rollback]({{< relref "/docs/reference/glossary#rollback" >}}), work stacking |
| [Data & State]({{< relref "/docs/reference/defect-sources/data-and-state" >}}) | Schema migration failures, null assumptions, concurrency issues, cache invalidation |
| [Dependency & Infrastructure]({{< relref "/docs/reference/defect-sources/dependency-and-infrastructure" >}}) | Third-party breaking changes, environment differences, network partition handling |
| [Security & Compliance]({{< relref "/docs/reference/defect-sources/security-and-compliance" >}}) | Vulnerabilities, secrets in source, auth gaps, injection, regulatory requirements, audit trails |
| [Performance & Resilience]({{< relref "/docs/reference/defect-sources/performance-and-resilience" >}}) | Regressions, resource leaks, capacity limits, missing timeouts, graceful degradation |
...
- [Testing]({{< relref "/docs/testing" >}}) - Testing types, patterns, and good practices
