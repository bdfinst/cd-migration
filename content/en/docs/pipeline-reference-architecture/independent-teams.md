...
| **Consumer-driven contracts** | Consumers publish pacts describing the subset of the provider API they depend on. Provider runs these pacts in its pipeline. See [Contract Tests](../../testing/contract/). | High - shared tooling, broker, and agreement to maintain pacts | Teams are in the same organization with shared tooling and willingness to maintain pacts |
...
- [Contract Tests](../../testing/contract/) - contract testing patterns and examples
