...
- **Partial multi-call failure**: compensation, [rollback]({{< relref "/docs/reference/glossary#rollback" >}}), or documented partial-success behavior. First client double succeeds, second fails.
