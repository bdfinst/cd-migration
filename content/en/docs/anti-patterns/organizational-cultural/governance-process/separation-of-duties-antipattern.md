...
|--------|-----------------|
| [Lead time]({{< relref "/docs/reference/metrics/lead-time" >}}) | Significant reduction as the deployment queue wait is eliminated |
| [Release frequency]({{< relref "/docs/reference/metrics/release-frequency" >}}) | Increase beyond the deployment team's capacity ceiling |
| [Change fail rate]({{< relref "/docs/reference/metrics/change-fail-rate" >}}) | Should remain flat or improve as automated gates are more consistent than manual review |
| [Development cycle time]({{< relref "/docs/reference/metrics/development-cycle-time" >}}) | Reduction in time changes spend waiting for deployment authorization |
