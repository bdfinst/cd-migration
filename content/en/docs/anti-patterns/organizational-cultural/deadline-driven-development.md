...
- [Pressure to Skip Testing](../pressure-to-skip-testing/) - Deadline pressure is the most common reason teams skip tests
- [Working Agreements](../../../migrate-to-cd/migration-path/foundations/working-agreements/) - Establishing "quality is not negotiable" as a team norm
- [Metrics-Driven Improvement](../../../migrate-to-cd/migration-path/optimize/metrics-driven-improvement/) - Using data to demonstrate the cost of deadline-driven shortcuts
- [Missing Product Ownership](../missing-product-ownership/) - Without a product owner, there is nobody to negotiate scope against deadlines
- [Velocity as Individual Metric](../velocity-as-individual-metric/) - Deadline culture and individual metrics reinforce each other
