...
- **Ignoring failed deployments.** If you count deployments that are immediately
  ...
  [Change Fail Rate](../change-fail-rate/) to get the full picture.
...
- **Focusing on speed without quality.** If release frequency increases but
  [Change Fail Rate](../change-fail-rate/) also increases, the team is releasing
...
- Reduce [Development Cycle Time](../development-cycle-time/) by decomposing work
