...
1. **Do post-mortems show the same root causes in the same areas of the system?** If recurring
   ...
   learning. Start with [Thin-Spread Teams]({{< relref "/docs/anti-patterns/organizational-cultural/team-dynamics/thin-spread-teams" >}}).
...
- [Domain Model Erosion]({{< relref "/docs/symptoms/flow/developer-experience/domain-model-erosion" >}}) - Structural degradation caused by repeated uninformed decisions
- [Thin-Spread Teams]({{< relref "/docs/anti-patterns/organizational-cultural/team-dynamics/thin-spread-teams" >}}) - Rotation model that prevents institutional memory from forming
- [Knowledge Silos]({{< relref "/docs/anti-patterns/team-workflow/knowledge-silos" >}}) - Knowledge not externalized into artifacts the next team can use
