...
- [Work Items Take Days or Weeks to Complete](../work-items-take-too-long/) - Idle blocked work drives up cycle time
- [Everything Started, Nothing Finished](../too-much-wip/) - Blocked items accumulate as excess WIP
- [Team Membership Changes Constantly](../team-instability/) - Knowledge silos worsen when people leave
- [Push-Based Work Assignment](../../anti-patterns/team-workflow/push-based-work-assignment/) - Assignment model that prevents swarming
- [Knowledge Silos](../../anti-patterns/team-workflow/knowledge-silos/) - Concentrated knowledge that prevents handoff
- [Limiting WIP](../../migrate-to-cd/migration-path/optimize/limiting-wip/) - WIP limits make blocked items visible and prompt swarming
