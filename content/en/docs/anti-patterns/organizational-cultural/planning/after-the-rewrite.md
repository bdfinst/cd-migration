...
| [Release frequency]({{< relref "/docs/reference/metrics/release-frequency" >}}) | Should increase as deployment automation reduces the friction of deploying the existing system |
| [Lead time]({{< relref "/docs/reference/metrics/lead-time" >}}) | Should decrease for the existing system as manual steps are automated |
