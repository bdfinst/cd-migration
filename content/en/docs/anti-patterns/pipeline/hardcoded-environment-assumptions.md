...
{{< card code=true header="**Externalizing a hardcoded URL to configuration (Java)**" lang="java" >}}
...
{{< card code=true header="**Replacing an environment-name feature toggle with a proper flag (JavaScript)**" lang="javascript" >}}
...
{{< card code=true header="**Replacing environment-gated email sending with dependency injection (Java)**" lang="java" >}}
