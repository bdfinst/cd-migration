...
| 2 | [Integration Tests]({{< relref "/docs/reference/testing/integration" >}}) | Verify boundaries - catch mismatched interfaces, serialization errors, query bugs | Yes | Fast enough to run on every commit |
| 3 | [Functional Tests]({{< relref "/docs/reference/testing/functional" >}}) | Verify your system works as a complete unit in isolation | Yes | Proves the system handles interactions correctly with all external dependencies stubbed |
| 4 | [Contract Tests]({{< relref "/docs/reference/testing/contract" >}}) | Verify your test doubles still match reality | No | Runs asynchronously; failures trigger review, not pipeline blocks |
| 5 | [End-to-End Tests]({{< relref "/docs/reference/testing/e2e" >}}) | Verify complete user journeys through the fully integrated system | No | Monitoring, not gating - runs post-deployment |

[Static Analysis]({{< relref "/docs/reference/testing/static" >}}) runs alongside layers 1-3, catching code quality, security, and
...
runs, both of which undermine [continuous integration]({{< relref "/docs/reference/glossary#ci-continuous-integration" >}}).
...
| Components interact correctly at a boundary | [Integration]({{< relref "/docs/reference/testing/integration" >}}) | Milliseconds to seconds | Yes | Yes |
| Your whole service works in isolation | [Functional]({{< relref "/docs/reference/testing/functional" >}}) | Seconds | Yes | Yes |
| Your test doubles match reality | [Contract]({{< relref "/docs/reference/testing/contract" >}}) | Seconds | No | No |
| A critical user journey works end-to-end | [E2E]({{< relref "/docs/reference/testing/e2e" >}}) | Minutes | No | No |
| Code quality, security, and style compliance | [Static Analysis]({{< relref "/docs/reference/testing/static" >}}) | Seconds | Yes | Yes |
| UI meets WCAG accessibility standards | [Static Analysis]({{< relref "/docs/reference/testing/static" >}}) + [Functional]({{< relref "/docs/reference/testing/functional" >}}) | Seconds | Yes | Yes |
...
| Type | Purpose |
|------|---------|
| [Unit Tests]({{< relref "/docs/reference/testing/unit" >}}) | Verify individual components in isolation |
| [Integration Tests]({{< relref "/docs/reference/testing/integration" >}}) | Verify components work together |
| [Functional Tests]({{< relref "/docs/reference/testing/functional" >}}) | Verify user-facing behavior |
| [End-to-End Tests]({{< relref "/docs/reference/testing/e2e" >}}) | Verify complete user workflows |
