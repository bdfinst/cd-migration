...
- [Architecture Decoupling](../../../migrate-to-cd/migration-path/optimize/architecture-decoupling/) - Reducing coupling between products makes ownership boundaries cleaner
