...
(see [Systemic Defect Fixes]({{< relref "/docs/reference/defect-sources" >}})), and AI can detect ambiguity faster than
manual review.
...
- Deterministic [CD]({{< relref "/docs/reference/glossary#cd-continuous-delivery" >}}) pipelines that run on every commit
...
**Brownfield phase:** Optimize / [Continuous Deployment]({{< relref "/docs/reference/glossary#continuous-deployment" >}})
...
Humans define what to test. [Agents]({{< relref "/docs/reference/glossary#agent-ai" >}}) generate the test code from those specifications. See [Acceptance Criteria]({{< relref "/docs/agentic-cd/specification/first-class-artifacts#4-acceptance-criteria" >}}) for the validation properties required before implementation begins.
{{% /alert %}}
...
- [Pitfalls and Metrics]({{< relref "/docs/agentic-cd/operations/pitfalls-and-metrics" >}}) - common failures when steps are skipped, and how to measure progress
- [Tokenomics]({{< relref "/docs/agentic-cd/operations/tokenomics" >}}) - how code quality drives token cost, and how to architect agents and workflows to minimize unnecessary consumption
- [The Four Prompting Disciplines]({{< relref "/docs/agentic-cd/getting-started/prompting-disciplines" >}}) - the skill layers developers need as they progress through the adoption roadmap
