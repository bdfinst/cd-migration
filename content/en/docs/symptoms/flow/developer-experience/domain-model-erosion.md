...
- [Slow Defect Resolution in the Domain]({{< relref "/docs/symptoms/flow/developer-experience/slow-defect-resolution" >}}) - Debugging becomes harder as the model becomes less legible
- [Thin-Spread Teams]({{< relref "/docs/anti-patterns/organizational-cultural/team-dynamics/thin-spread-teams" >}}) - Rotation model that accumulates independent interpretations
- [Knowledge Silos]({{< relref "/docs/anti-patterns/team-workflow/knowledge-silos" >}}) - Domain understanding not embedded in shared artifacts
