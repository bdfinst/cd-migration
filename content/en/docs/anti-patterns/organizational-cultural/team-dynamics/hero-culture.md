...
|--------|-----------------|
| [Mean time to repair]({{< relref "/docs/reference/metrics/mean-time-to-repair" >}}) | Should stay flat or improve as knowledge distribution improves incident response speed across the team |
| [Lead time]({{< relref "/docs/reference/metrics/lead-time" >}}) | Reduction as hero-dependent bottlenecks in the delivery path are eliminated |
| [Release frequency]({{< relref "/docs/reference/metrics/release-frequency" >}}) | Increase as deployments become possible without the hero's presence |
