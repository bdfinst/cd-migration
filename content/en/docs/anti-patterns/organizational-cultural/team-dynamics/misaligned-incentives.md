...
| [Deployment frequency]({{< relref "/docs/reference/metrics/release-frequency" >}}) | Should increase as teams have a goal to improve it |
| [Change fail rate]({{< relref "/docs/reference/metrics/change-fail-rate" >}}) | Should decrease as teams have a reason to invest in deployment quality |
