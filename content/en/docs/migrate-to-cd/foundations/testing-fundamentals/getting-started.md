...
### 4. Add functional tests for critical paths

If you do not have functional tests (component tests) that exercise your whole service in
...
**Output:** Functional tests covering your critical paths, running in CI on every commit.
...
- [Test Doubles]({{< relref "/docs/reference/testing/test-doubles" >}}) - Patterns for isolating dependencies
- [Contract Tests]({{< relref "/docs/reference/testing/contract" >}}) - Verifying test doubles match reality
