...
| **Chaos engineering** | Failure modes in distributed systems: what happens when a [dependency]({{< relref "/docs/reference/glossary#dependency" >}}) is slow, returns errors, or disappears | When you have functional tests and contract tests in place and need confidence in failure handling |
