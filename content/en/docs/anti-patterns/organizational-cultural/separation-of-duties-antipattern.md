...
|--------|-----------------|
| [Lead time](../../../metrics/lead-time/) | Significant reduction as the deployment queue wait is eliminated |
| [Release frequency](../../../metrics/release-frequency/) | Increase beyond the deployment team's capacity ceiling |
| [Change fail rate](../../../metrics/change-fail-rate/) | Should remain flat or improve as automated gates are more consistent than manual review |
| [Development cycle time](../../../metrics/development-cycle-time/) | Reduction in time changes spend waiting for deployment authorization |
| [Work in progress](../../../metrics/work-in-progress/) | Reduction as the deployment bottleneck clears |
| [Build duration](../../../metrics/build-duration/) | Monitor automated approval gates for speed; they should add minimal time to the pipeline |

## Related Content

- [Compliance interpreted as manual approval](../compliance-manual-approval/) - related pattern where compliance is used to justify other manual gates
- [Separate Ops/Release Team](../separate-ops-team/) - the organizational pattern this anti-pattern creates
- [Single path to production](../../../migrate-to-cd/migration-path/pipeline/single-path-to-production/) - the automated pipeline that replaces the manual deployment team role
- [Pipeline architecture](../../../migrate-to-cd/migration-path/pipeline/pipeline-architecture/) - design the pipeline with SoD controls built in
- [Rollback](../../../migrate-to-cd/migration-path/pipeline/rollback/) - automated rollback capability reduces the risk argument for keeping a separate deployment team
