...
| [Release frequency]({{< relref "/docs/reference/metrics/release-frequency" >}}) | Should increase as barriers are addressed and deployment becomes more routine |
| [Lead time]({{< relref "/docs/reference/metrics/lead-time" >}}) | Should decrease as practices that reduce handoffs and manual steps are adopted |
