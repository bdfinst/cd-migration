...
|--------|-----------------|
| [Release frequency](../../../metrics/release-frequency/) | Should increase from once per sprint toward multiple times per week |
| [Lead time](../../../metrics/lead-time/) | Should decrease as stories deploy when complete rather than at sprint end |
| Time from story complete to production deployment | Should decrease from up to 14 days to under 1 day |
| [Change fail rate](../../../metrics/change-fail-rate/) | Should decrease as smaller, individual deployments replace sprint batches |
| [Work in progress](../../../metrics/work-in-progress/) | Should decrease as "done but not deployed" stories are eliminated |
| [Mean time to repair](../../../metrics/mean-time-to-repair/) | Should decrease as production defects can be fixed and deployed immediately |

## Related Content

- [Small Batches](../../../migrate-to-cd/migration-path/optimize/small-batches/) - The principle that reduces deployment risk by reducing deployment size
- [Feature Flags](../../../migrate-to-cd/migration-path/optimize/feature-flags/) - Decoupling deployment from user visibility for product owner approval workflows
- [Work Decomposition](../../../migrate-to-cd/migration-path/foundations/work-decomposition/) - Stories small enough to complete and deploy frequently
- [Release Trains](release-trains/) - The same batch deployment pattern at a larger scale
- [Single Path to Production](../../../migrate-to-cd/migration-path/pipeline/single-path-to-production/) - One automated path that deploys any passing change on demand
