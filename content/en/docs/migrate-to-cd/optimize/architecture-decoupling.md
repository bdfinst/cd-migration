...
|--------|--------------|
| [Deployment frequency]({{< relref "/docs/reference/glossary#deployment-frequency" >}}) | Monthly or quarterly (because coordinating releases is hard) |
| [Lead time]({{< relref "/docs/reference/glossary#lead-time-for-changes" >}}) | Weeks to months (because changes wait for the next release train) |
...
- **Use consumer-driven contract tests** to verify compatibility. See [Contract Testing]({{< relref "/docs/reference/testing/contract" >}}).
...
With optimized flow, small batches, metrics-driven improvement, and a decoupled architecture, your team is ready for the final phase. Continue to [Phase 4: Deliver on Demand]({{< relref "/docs/migrate-to-cd/continuous-deployment" >}}).
...
- [Contract Testing]({{< relref "/docs/reference/testing/contract" >}}) - the testing approach that enables independent deployment of services
