...
| [Change fail rate]({{< relref "/docs/reference/metrics/change-fail-rate" >}}) | Should decrease as quality improves continuously rather than in bursts |
| Duration of stabilization period before release | Should trend toward zero as the codebase is kept releasable continuously |
| [Lead time]({{< relref "/docs/reference/metrics/lead-time" >}}) | Should decrease as the hardening delay is removed from the delivery cycle |
