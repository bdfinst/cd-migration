...
|--------|-----------------|
| [Mean time to repair]({{< relref "/docs/reference/metrics/mean-time-to-repair" >}}) | Should decrease as the team with code knowledge is involved in incident response |
| Incident recurrence rate | Should decrease as root causes are identified and fixed by the team that built the service |
| [Change fail rate]({{< relref "/docs/reference/metrics/change-fail-rate" >}}) | Should decrease as operational feedback informs development quality decisions |
