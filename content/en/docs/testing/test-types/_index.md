...
The list isn't exhaustive and the boundaries between types aren't crisp in every codebase. Use these definitions as shared vocabulary for the rest of the testing section, especially [Applied Testing Strategies]({{< relref "/docs/testing/applied-testing-strategies" >}}) and [Testing Antipatterns]({{< relref "/docs/testing/antipatterns" >}}).
