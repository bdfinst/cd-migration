...
3. **Does a committee or approval board gate production changes?** If releases wait for scheduled
   approval meetings, the approval cadence is the [constraint]({{< relref "/docs/reference/glossary#constraint" >}}). Start with
...
4. **How large is the typical work item?** If features take weeks and are delivered as single
   units, the [batch size]({{< relref "/docs/reference/glossary#batch-size" >}}) is the constraint. Start with
