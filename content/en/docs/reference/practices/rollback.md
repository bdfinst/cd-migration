...
- [Rollback]({{< relref "/docs/migrate-to-cd/pipeline/rollback" >}}) - Phase 2 pipeline practice with blue-green, canary, feature flag, and database-safe rollback patterns
