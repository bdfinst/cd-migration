...
|-------|-------------------|-------------------|-------------------|-----|
| Known vulnerabilities in dependencies | [CI](../glossary/#ci-continuous-integration) | Software composition analysis, CVE database scanning, dependency lock file auditing | <span class="ai-high">&#9650;</span> Correlate vulnerability advisories with actual usage paths to prioritize exploitable risks over theoretical ones | Automated dependency updates with test gates; pin and audit all transitive dependencies |
