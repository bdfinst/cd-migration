...
3. **Do developers treat review as lower priority than their own coding work?** If yes, the
   ...
   [Push-Based Work Assignment]({{< relref "/docs/anti-patterns/team-workflow/push-based-work-assignment" >}}) and
   establish a team [working agreement]({{< relref "/docs/reference/glossary#working-agreement" >}}) that reviews happen before starting new work.
