...
- **Optimizing for speed without quality.** If cycle time drops but
  [Change Fail Rate](../change-fail-rate/) rises, the team is cutting corners.
...
- **Subsumes other metrics.** Cycle time is affected by [Integration
  Frequency](../integration-frequency/), [Build Duration](../build-duration/),
  and [Work in Progress](../work-in-progress/). Improving any of these upstream
...
- Limit [Work in Progress](../work-in-progress/) so the team focuses on finishing
