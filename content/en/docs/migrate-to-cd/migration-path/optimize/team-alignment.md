...
the user interface, the business logic, the data store, and the deployment [pipeline](../../../glossary/#pipeline) - they can
...
A [full-stack product team](../../../glossary/#full-stack-product-team) owns the complete user-facing surface for a feature area - from
the UI components a user interacts with down through the business logic and the database. The team
has no [hard dependency](../../../glossary/#hard-dependency) on a separate frontend or backend team. One team ships the entire vertical
slice.

A [subdomain product team](../../../glossary/#subdomain-product-team) owns a service or set of services representing a bounded business
...
Both patterns share the same structure: **one team, one [deployable](../../../glossary/#deployable), full ownership**. The team
...
**[Feature teams](../../../glossary/#feature-team) without domain ownership.** Teams are organized around feature areas, but each
...
See [Architecture Decoupling](architecture-decoupling/) for the technical strategies to establish
independent service boundaries. See [Tightly Coupled Monolith](../../../anti-patterns/architecture/tightly-coupled-monolith/)
...
4. **Contract tests.** Write tests that verify the producer honors the contract. Write tests that
   verify the consumer handles the contract correctly. See [Contract Testing](../../../testing/contract/)
...
pipeline configurations. See [Multiple Teams, Single Deployable](../../../pipeline-reference-architecture/multi-team/)
for a worked example of this pattern when teams share a [modular monolith](../../../glossary/#modular-monolith).
...
- [Architecture Decoupling](architecture-decoupling/) - the technical counterpart to team alignment; both must move together
- [Multiple Teams, Single Deployable](../../../pipeline-reference-architecture/multi-team/) - pipeline pattern for teams sharing a modular monolith before full service separation
- [Horizontal Slicing](../../../anti-patterns/team-workflow/horizontal-slicing/) - the work decomposition anti-pattern that layer team structures encourage
- [Tightly Coupled Monolith](../../../anti-patterns/architecture/tightly-coupled-monolith/) - the architecture anti-pattern that misaligned team ownership produces
- [Thin Spread Teams](../../../anti-patterns/organizational-cultural/thin-spread-teams/) - the organizational anti-pattern of distributing engineers too thin across too many services
- [Work Decomposition](../../foundations/work-decomposition/) - how to slice work vertically within a team's domain boundary
- [Contract Testing](../../../testing/contract/) - how to define and enforce the contracts between domain teams
