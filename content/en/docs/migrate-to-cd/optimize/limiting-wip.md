...
| "I'm idle because another team hasn't finished the API I depend on" | Architecture is too tightly coupled (see [Architecture Decoupling]({{< relref "/docs/migrate-to-cd/optimize/architecture-decoupling" >}})) |
...
- Discuss in [retrospectives]({{< relref "/docs/migrate-to-cd/optimize/retrospectives" >}}): Is the limit too high? Too low? What bottlenecks are exposed?
...
|--------|--------|----------------|
| [Work in progress]({{< relref "/docs/reference/metrics/work-in-progress" >}}) | At or below team limit | Confirms the limit is being respected |
| [Development cycle time]({{< relref "/docs/reference/metrics/development-cycle-time" >}}) | Decreasing | Confirms that less WIP leads to faster delivery |
...
WIP limits expose problems. [Metrics-Driven Improvement]({{< relref "/docs/migrate-to-cd/optimize/metrics-driven-improvement" >}}) provides the framework for systematically addressing them.
...
- [PRs Waiting for Review]({{< relref "/docs/symptoms/flow/integration/prs-waiting-for-review" >}}) - a bottleneck that WIP limits expose
- [Unbounded WIP]({{< relref "/docs/anti-patterns/team-workflow/unbounded-wip" >}}) - the anti-pattern of having no limits on work in progress
- [Push-Based Work Assignment]({{< relref "/docs/anti-patterns/team-workflow/push-based-work-assignment" >}}) - the anti-pattern of assigning work rather than letting teams pull it
- [Work in Progress metric]({{< relref "/docs/reference/metrics/work-in-progress" >}}) - how to measure and track WIP over time
