...
|--------|-----------------|
| [Change fail rate]({{< relref "/docs/reference/metrics/change-fail-rate" >}}) | Should improve as systemic post-mortems identify and fix the conditions that allow failures |
| [Mean time to repair]({{< relref "/docs/reference/metrics/mean-time-to-repair" >}}) | Reduction as engineers disclose problems earlier and respond more openly |
| [Lead time]({{< relref "/docs/reference/metrics/lead-time" >}}) | Improvement as engineers stop padding timelines to manage blame exposure |
