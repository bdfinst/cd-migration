...
| **19-22** | You are well-practiced in most areas. Your migration is about closing specific gaps and optimizing flow. | Review your unchecked items - they point to specific topics in **[Phase 3 - Optimize](../../optimize/)** or **[Phase 4 - Deliver on Demand](../../continuous-deployment/)**. |
| **23-25** | You are already practicing most of what MinimumCD defines. Your focus should be on consistency and delivering on demand. | Jump to **[Phase 4 - Deliver on Demand](../../continuous-deployment/)** and focus on the capability to deploy any change when needed. |
