...
| **Component** | Verify component behavior from the actor's perspective with [test doubles]({{< relref "/docs/testing/glossary#test-double" >}}) for external dependencies | Yes, gates the build | No (localhost only) |
...
2. Write component tests from the actor's perspective. A user submitting a form, a service
   ...
   interface.
3. Replace external dependencies with [test doubles]({{< relref "/docs/testing/glossary#test-double" >}}).
   ...
   deterministic.
4. Add [contract tests]({{< relref "/docs/testing/test-types/contract" >}}) to validate that your test doubles
...
- [Component Tests]({{< relref "/docs/testing/test-types/component" >}}) - Testing your system in isolation with test doubles
- [Contract Tests]({{< relref "/docs/testing/test-types/contract" >}}) - Verifying that test doubles match reality
- [Test Doubles]({{< relref "/docs/testing/glossary#test-double" >}}) - Techniques for replacing external dependencies in tests
- [End-to-End Tests]({{< relref "/docs/testing/test-types/e2e" >}}) - When and how to use E2E tests appropriately
