...
**Read more:** [Work Decomposition](../../migrate-to-cd/migration-path/foundations/work-decomposition/)
...
- [Everything Started, Nothing Finished](../too-much-wip/) - Rework adds unplanned items that inflate WIP
- [Work Items Take Days or Weeks to Complete](../work-items-take-too-long/) - Rework loops extend cycle time
- [Push-Based Work Assignment](../../anti-patterns/team-workflow/push-based-work-assignment/) - Assignment without context leads to intent mismatch
- [Work Decomposition](../../migrate-to-cd/migration-path/foundations/work-decomposition/) - Breaking work into slices with clear, outcome-focused acceptance criteria
- [Working Agreements](../../migrate-to-cd/migration-path/foundations/working-agreements/) - Team norms for refinement and Three Amigos sessions
