...
| [Development cycle time](../../../metrics/development-cycle-time/) | Should decrease as stories are decomposed to a consistent size and ambiguity is resolved before development starts |
...
- [Work Decomposition](../../../migrate-to-cd/migration-path/foundations/work-decomposition/) - The practice that makes small, consistent stories possible
- [Small Batches](../../../migrate-to-cd/migration-path/optimize/small-batches/) - Why smaller work items improve delivery more than better estimates
- [Working Agreements](../../../migrate-to-cd/migration-path/foundations/working-agreements/) - Establishing shared norms around what "ready to start" means
- [Metrics-Driven Improvement](../../../migrate-to-cd/migration-path/optimize/metrics-driven-improvement/) - Using throughput data as a more reliable planning input than velocity
- [Limiting WIP](../../../migrate-to-cd/migration-path/optimize/limiting-wip/) - Reducing the number of stories in flight improves delivery more than improving estimation
